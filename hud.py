...
class HUD:
    def __init__(self, game):
        """Initialize HUD elements with reference to the game instance."""
        self.game = game
        ...
        # Call update_scores to initialize score-related attributes
        self.update_scores()
    
    def _setup_life_image(self):
        """Prepare the life icon image used to represent remaining lives."""
    ...
    def update_score(self):
        """Render the current score to be displayed on the screen.""" 
    ...
    def update_max_score(self):
        """Render the session's max score on the screen.""" 
    ...
    def update_hi_score(self):
        """Render the all-time high score on the screen.""" 
    ...
    def update_level(self):
        """Update the current level on the screen.""" 
    ...
    def _draw_lives(self):
        """Draw the remaining lives as icons on the screen."""
    ...
    def draw(self):
        """Draw the entire HUD on the screen."""
